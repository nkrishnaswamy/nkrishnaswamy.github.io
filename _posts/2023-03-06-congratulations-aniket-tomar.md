...
Aniket's thesis is entitled *Exploring Correspondences Between Gibsonian and Telic Affordances for Object Grasping using 3D Geometry*. This is a really interesting work in that Aniket took what was initially a negative result and probed it enough to draw a robust conclusion about the representation of Gibsonian and telic affordaces in 3D data and the difficulty of embodied tasks for even specialized machine learning models. Part of this work appeared in our [AREA workshop paper](https://www.nikhilkrishnaswamy.com/assets/docs/pdfs/AREA-2022.pdf) at ESSLLI last summer. 
...
(X-posted on [signallab.ai](https://www.signallab.ai/congratulations-aniket-tomar))
